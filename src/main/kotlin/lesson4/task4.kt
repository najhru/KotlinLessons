...
fun main() {
    val trainingDay = 5
    val groupTraining = trainingDay % 2 == 0
    println("Упражнения для рук: ${!groupTraining}\nУпражнения для ног: $groupTraining\n" +
            "Упражнения для спины: $groupTraining\nУпражнения для пресса: ${!groupTraining}")
}